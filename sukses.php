			...
			<tr>
				<td>
						...
						<tr height="40px">
							...
							<th width="35%">
								<table width="100%"bgcolor="white" align="center">
									<tr height="25px">
										<td width="100%"><font color ="BROWN" size="3" face="Lucida Calligraphy" align="left"><?php echo $_GET["name"]; ?> </td>
									</tr>
									<tr height="25px">
										<td width="100%"><font color ="BROWN" size="3" face="Lucida Calligraphy"><?php echo $_GET["email1"]; ?> </td>
									</tr>	
								</table>
							</th> 
							<th width="8%"><div class="dropdown">
					...
					<table width="100%" Align="Center" bgcolor="black">
						<th><p style="font:bold 30px Gabriola ;color:#ff9900" align=center><br><img src="../tugasakhir/sukses.gif" width="300px" height="300px" 
						title="Downloading"><br>Please Check Your email "<i> <?php echo $_GET["email1"]; ?> </i> " and Use " <i> <?php echo $_GET["pass"]; ?> </i>" for password <br><br><br> </th>
					</table>
					<table>
						<tr height="40px">
